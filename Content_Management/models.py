...
class Candidate(models.Model):
    ...
    candidate_experience = models.IntegerField(null=True, default=0)
    preferred_location = models.CharField(max_length=200, null=True)
    current_ctc = models.IntegerField(null=True, default=0)
    expected_ctc = models.IntegerField(null=False, default=0)
